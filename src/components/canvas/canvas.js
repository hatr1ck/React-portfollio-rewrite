...
class Works extends Component {
    ...
    render() {
      ...
      <Link to='/'><img alt='404' src={home} height='100rem' className='imge'/></Link>
            <div style={{width:window.innerWidth / 100 * 84 + 3}} className='menu'>
       <h4>My canvas experiment that have no ending purpose. Basically it's a bunch of circles that change collor when they collide.</h4>
            <MuiThemeProvider>
                    <SelectField
          floatingLabelText="Amount"
          value={this.state.amount}
          onChange={this.onAmountChange}
          inputProps={{fontSize:'150px'}}
        >
          <MenuItem value={10} primaryText="10" />
          <MenuItem value={20} primaryText="20" />
          <MenuItem value={30} primaryText="30" />
          <MenuItem value={50} primaryText="50" />
          <MenuItem value={Math.round((window.innerHeight / 60) * (window.innerWidth / 100 * 84 / 60) / 2)} primaryText='Max' />
        </SelectField>
                    <SelectField
        ...
        >
          ...
          <MenuItem value={"transparent"} primaryText="transparent" />
              ...
              <canvas style={{backgroundColor: this.state.color}} ref="canvas" />
            </div>
