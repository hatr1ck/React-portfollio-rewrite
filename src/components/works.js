...
class Works extends Component {
    state= {
      projects: [{title:"Weather API", link:"/weather", description:"1", pic:""},
                {title:"Weather API",  link:"/todo", description:"2", pic:""},
                {title:"Weather API", link:"/goodreads", description:"3", pic:""},
                {title:"Weather API", link:"/frog", description:"4", pic:"http://images.clipartpanda.com/frog-clip-art-bug-eyed-frog.svg"}
]}
